...
function EditEmployee() {
  ...
  useEffect(() => {
    ...
    filterclientname = [...new Set(filterclientname.map(JSON.stringify))].map(
      JSON.parse
    );
    setProjList(data);
    const columns = [
...
<TopNavBarCustom />
            ...
            <div class="row">
              <div class="common-filter">
                <ul class="filter-fields tab-project-list">
                  ...
                  <li style={{ marginLeft: 24 + "px" }}>
                    <button class="outline-btn" onClick={() => handleModal()}>
                      Custom
                    </button>
                  </li>
                </ul>
      ...
      <Modal
        show={show}
        onHide={() => handleModal()}
        className="edit-employee-modal date-modal"
      >
