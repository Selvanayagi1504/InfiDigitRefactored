...
function ModuleExpandNonComplaint() {
  ...
  function addClass(i) {
    ...
    if (l == 1) document.getElementById(a).classList.add("yes");
    else document.getElementById(a).classList.remove("yes");
  }
  ...
  const [chartoptions, setchartoptions] = useState({
    ...
    labels: ["Jan21", "Feb 21", "Mar 21", "Apr 21", "May 21", "Jun 21"],
    xaxis: {
      type: "datetime",
    },
    yaxis: [
          ...
          <div class="dashboard-wrapper">
            <div class="sidebar-nav-bar">
              <ul class="list-unstyled side-menu">
                ...
                <li>
                  <a href="module-expand-page-speed">
                ...
                <li>
                  <a href="module-expand-site-uptime">Site Uptime Monitor</a>
                </li>
                <li>
                  <a href="module-expand-gsc">GSC Data Extractor</a>
                </li>
                <li>
                  <a href="module-expand-organic-research">
                    Organic Research module
                  </a>
                </li>
                <li>
                  <a href="module-expand-roi">ROI Calculator</a>
                </li>
                <li>
                  <a href="content-word-count">Content Word Count on a Page</a>
                </li>
                <li>
                ...
                <li>
                  <a href="module-expand-seo-audit">SEO Audit</a>
                </li>
              </ul>
            </div>
            ...
            <div className="row">
              <div className="ms-5 mb-5">
                <div class="pagination p12">
                  <a onClick={pagePrev} class="prev" href="#">
                    <li>&lt;</li>
                  </a>
                  <ul>
                    {pageArray.map((item) => {
                      return (
                        <a
                          class={`button-${item.page}`}
                          onClick={() => {
                            pageCapture(item.page);
                          }}
                          href="#"
                        >
                          <li>{item.page}</li>
                    ...
                    <a onClick={pageNext} class="next" href="#">
                      <li>&gt;</li>
                    </a>
                  </ul>
                </div>
