...
function ModuleExpandSEOAudit() {
    ...
    data = [
      {
        ...
        nonCompliants: (
          <Link
            to={{
              pathname: "/module-expand-non-compliant",
              search: `?id=1`,
              state: { detail: "1" },
            }}
          >
  ...
  const [chartoptions, setchartoptions] = useState({
    ...
    labels: ["Feb-21", "Mar-21", "Apr-21", "May-21", "Jun-21"],
    xaxis: {
      type: "datetime",
    },
    yaxis: [
          ...
          <div className="Common-mt-64">
            {popover ? (
              <div className="pop-over">
                {/* pagination */}
                <button
                  className="close-button close p-3 btn btn-danger"
            ...
            <div className="row common-mb-24">
              <div class="col-sm-6 pad-lzero" style={{ display: "flex" }}>
                ...
                <span style={{ width: 50 + "%", marginLeft: 24 + "px" }}></span>
              </div>
              ...
              <div className="col-sm-5 p-5 margin-left-seo-audit-5 mt-5 mt-md-0 progress-text">
                ...
                <div className="text-center">
                  <div
                    ...
                    style={{ backgroundColor: `${progressTextColor}` }}
                  >
                    {progress}
                  </div>
                </div>
                <div className="text-center mt-4" style={{ width: "100%" }}>
                  <button
                    class="outline-btn audit-button"
                    type="button"
                    onClick={() => setPopOver(!popover)}
                  >
                    Audit
