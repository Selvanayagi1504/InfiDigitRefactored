      ...
      <section class="outer-wrapper">
        ...
        <div class="sidebar-nav-bar">
          <ul class="list-unstyled side-menu">
            ...
            <li>
              <a href="team-members-sales-dir">
                <i class="fa fa-tasks"></i> Team Members
              </a>
            </li>
            <li>
              <a href="clinets-sales-dir">
                <i class="fa fa-tasks"></i> Clients
              </a>
            </li>
            <li>
              <a href="project-list-sales-dir">
          ...
          <div class="dashboard-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-sm-7 add-new-btnw">
                <a style={{ color: "#0d6efd" }} onClick={() => handleModal()}>
                  View / Add Notes
                </a>
              </div>
            </div>
