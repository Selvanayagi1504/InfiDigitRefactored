              ...
              <TabPanel>
                <div className="row">
                      ...
                      {categorylist.map((i) => {
                        return (
                          <li>
                            <a
                              className={
                                enhanceactive == i.category
                                  ? "bold-active-enhance"
                                  : ""
                              }
                              id={i.category}
                              onClick={() =>
                                chooseenhancelist(i.category, i.rating)
                              }
                            >
                              {i.category}
                            </a>
                  ...
                  <div className="col-md-10 seo-right">
                    ...
                    <div
                      className="add-new-btnw"
                      style={{ marginTop: 24 + "px" }}
                    >
                      <button
                        class="outline-btn generate-report"
                        onClick={() => generatereportseo()}
                      >
                        Generate
                      </button>
                    </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-8">
                        ...
                        {enhancerating < 5 ? (
                          <>
                            <div className="description-rating">
                              <div class="Normal">Normal range</div> Another
                              ordinary day. Although some sites experience
                              insignificant rankings changes, this is most
                              likely because these sites or their backlink
                              profiles are being updated. There is nothing to
                              worry about.
                            </div>
                          </>
                        ) : (
                        ...
                        {enhancerating >= 5 && enhancerating < 8 ? (
                          <>
                            <div className="description-rating">
                              <div class="high">High range</div>Position changes
                              for numerous sites! Google results are shaking up.
                              This may be a sign of a possible algorithm change.
                        ...
                        {enhancerating >= 8 ? (
                          <>
                            <div className="description-rating">
                              <div class="very-high">Very High range</div>
                              There're constant and massive tremors on Google
                              search results, suggesting a significant algorithm
                              update. It's time to check if your site is going
                              up/down.
                            </div>
                          </>
                        ) : (
                    ...
                    <div className="score-maintain">
                      <a
                        style={{ color: "white", marginRight: 24 + "px" }}
                        class="outline-btn"
                        onClick={() => handleModal()}
                      >
                        Custom
                    ...
                    <div className="add-new-btnw">
                      <select
                        ...
                        onChange={() => {
                          generateChart(
                            document.getElementById("chosecate").value
                          );
                        }}
                      >
