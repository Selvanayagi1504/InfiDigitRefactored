...
function ModuleExpandROI() {
  ...
  const [selectionTypeClickShare, setSelectionTypeClickShare] =
    useState("checkbox");
  ...
  return (
    <>
              ...
              <TabPanel>
                <div className="row">
                  <div className="col-md-3">
                    ...
                    <input
                      class="common-height-30-padding"
                      type="text"
                      name=""
                      id=""
                    />
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <div className="row">
                      ...
                      <div
                        className="col-md-4 add-new-btnw "
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4">
                        ...
                        <select
                          class="common-height-30-padding"
                          id="roi-choose-method"
                          onChange={() => {
                            openModal(
                              document.getElementById("roi-choose-method").value
                            );
                          }}
                        >
                ...
                <div className="row">
                  <div className="col-md-6 custom-borrig">
                    <div
                      className="da-average-div common-mb-24"
      ...
      <Modal
        show={show}
        onHide={() => handleModal()}
        className="edit-employee-modal ROI-modal"
      >
