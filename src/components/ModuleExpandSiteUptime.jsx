    ...
    if (optionSelected1 && optionSelected) {
      ...
      data.map((i, index) => {
        optionSelected.map((j) => {
          ...
          if (i.fields == "Meta Title") data[index][x] = "Shoes For Men";
          else if (i.fields == "Meta Description") data[index][x] = "Men Shoes";
        });
      });
      console.log(data);
      setkeytablelist(b);
                ...
                {displayTable ? (
                  <>
                    ...
                    <div className="row ">
                      ...
                      <div
                        className="col-md-12 table-graph-modules"
