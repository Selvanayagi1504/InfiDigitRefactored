...
function ModuleExpandPageSpeed() {
  ...
  const [selectionTypePageSpeed, setSelectionTypePageSpeed] =
    useState("checkbox");
  ...
  useEffect(() => {
    ...
    var data = [
      ...
      {
        key: 1,
        url: "https://www.infidigit.com/seo-search-engine-optimization/",
        fcp: "2.6",
        fid: "1.5",
        lcp: "2.1",
        cls: "0.09",
      ...
      {
        key: 2,
        url: "https://www.infidigit.com/digital-marketing-services/",
        fcp: "3",
        fid: "204",
        lcp: "4.1",
        cls: "0.06",
      ...
      {
        key: 4,
        url: "https://www.ezrankings.org/seo-packages.html",
        fcp: "4",
        fid: "156",
        lcp: "2.1",
        cls: "0.05",
    ...
    var color = [
      {
        value: "https://www.infidigit.com/",
        label: "https://www.infidigit.com/",
      },
      {
        value: "https://www.infidigit.com/seo-search-engine-optimization/",
        label: "https://www.infidigit.com/seo-search-engine-optimization/",
      },
      {
        value: "https://www.infidigit.com/digital-marketing-services/",
        label: "https://www.infidigit.com/digital-marketing-services/",
      },
      {
        value: "https://www.ezrankings.org/",
        label: "https://www.ezrankings.org/",
      },
      {
        value: "https://www.ezrankings.org/seo-packages.html",
        label: "https://www.ezrankings.org/seo-packages.html",
      },
    ];
    setcolor(color);
    setallOptions(color);
          ...
          <div className="Common-mt-64">
            ...
            <div ref={ref} class="calendar-main">
              <div className="add-new-btnw">
                <button
                  className="outline-btn-boderless"
                  style={{ width: "250px" }}
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-4 mt-3 mt-lg-0 text-center">
                        ...
                        <div className="row mt-3 text-center">
                          ...
                          <div className="col-5">
                            {values.length == 2 ? (
                              <input type="text" value={values[1].format()} />
                            ) : (
            ...
            <Tabs>
              ...
              <TabPanel>
                <div class="common-flex-div common-mt-24">
                  <label class=" common-mt-5 common-mr-24 common-label">
                    Device Type
                  </label>
                  ...
                  <a
                    ...
                    class="common-height-30 outline-btn"
                  >
                    Search
                  </a>
                </div>
                        ...
                        <div className="row">
                          <div className="col-lg-6 common-flex-div">
                            <label
                              ...
                              class="common-mr-24 common-label common-mt-5"
                              htmlFor=""
                            >
                              URL
                            </label>
                            <select
                              id="select-url-page-speed"
                              onChange={handleURLChange}
                            >
                              <option value="https://www.infidigit.com/">
                                https://www.infidigit.com/
                              </option>
                              <option value="https://www.ezrankings.org/">
