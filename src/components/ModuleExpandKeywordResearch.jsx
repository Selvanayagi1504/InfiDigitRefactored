...
function ModuleExpandKeywordResearch() {
  ...
  return (
    <>
      <section class="outer-wrapper module-expand-keyword dashboard-seo dashboard-seo-bradcrumb">
        <TopNavBarCustom />
        {/* {usertype == "SEO" ? (
                      ...
                      <div className="col-lg-4 mt-3 mt-lg-0 text-center">
                        ...
                        <div className="row mt-3">
                          <div className="col-6 ">
                            ...
                            />
                            <label className="lable-compare common-label">
                              Compare to
                            </label>
                          </div>
                          <div className="col-5">
              ...
              <TabPanel>
                ...
                <div className="row">
                  <div className="col-lg-3 my-2">
                    ...
                    <SearchBar
                      class="input common-height-30-padding"
                ...
                <div className="row" style={{ marginTop: 24 + "px" }}>
                  <div className="col-lg-3 my-2">
                    ...
                    <button
                      className="outline-btn-boderless common-height-30-padding"
                  ...
                  <div className="col-lg-3 my-2">
                    <div className="row">
                      ...
                      <div
                        className="col-lg-6 ms-sm-5"
                        style={{ width: 205 + "px", marginLeft: 0.4 + "rem" }}
                      >
                        <img
                          src="/static/media/funnel-fill.e44527ec.svg"
                          alt="filter"
                          class="filterimage"
                          onClick={() => {
                            handleModalKR();
                  ...
                  <div className="col-lg-3 my-2 ">
                    <button
                      className="outline-btn common-height-30-padding"
                      onClick={generate}
                    >
                      Generate
                    </button>
      ...
      <Modal
        show={showKR}
        onHide={() => handleModalKR()}
        className="edit-project modal-KR"
      >
