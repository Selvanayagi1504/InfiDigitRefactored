...
import { Table, Input, Row, Col,  Drawer, Breadcrumb } from "antd";
...
function ViewClientDetails() {
  ...
  const [colourOptionsmodule, setcolormodule] = useState([
    ...
    {
      value: "Page Speed and Core Web Vitals",
    ...
    {
      value: "Content Word Count On page",
      label: "Content Word Count On page",
    },
    ...
    {
      value: "Google Analytics Data Extractor",
      label: "Google Analytics Data Extractor",
    },
  ]);
        ...
        <div className="Common-Row-Div">
          ...
          <div className="common-mt-64">
            <Breadcrumb>
              ...
              <Breadcrumb.Item>
                <a href="/dashboard-seo">Dashboard</a>
              </Breadcrumb.Item>
              <Breadcrumb.Item>
            ...
            <Tabs className="tabs-inner-page-speed">
              ...
              <TabPanel>
                <div class=" pad-lzero" style={{ display: "flex" }}>
                  ...
                  <span
                    style={{ width: 50 + "%", marginLeft: 24 + "px" }}
                  ></span>
                </div>
                <div className="row" style={{ marginBottom: 24 + "px" }}>
                  <div className="col-lg-9">
                    <div
                      style={{ display: "flex" }}
                      class="add-new-btnw view-client-tab-3"
                    >
                      <label
                        htmlFor=""
                    ...
                    <div style={{ display: "flex" }} class="add-new-btnw">
                      ...
                      <input
                        ...
                        id="inputurl-view-clinet"
                      />
                      <a
                        onClick={handleurlInput}
                        href="#"
                        style={{ marginLeft: 24 + "px", height: 38 + "px" }}
                        class="outline-btn"
                      >
                        Generate Report
                      </a>
                ...
                {reportgentable && reportgentable.length > 0 ? (
                  <>
                    <Table
                      ...
                      columns={reportgencol}
                      dataSource={reportgentable}
                      rowSelection={{
                        type: selectionTypeReport,
                        ...rowSelection,
                      }}
                    ...
                    <div className="row">
                      <div className="col-md-8">
                        ...
                        <select
                          name=""
                          id="url-module-expand"
                          placeholder="Select Url"
                        >
                          <option value="">https://www.ezrankings.org/</option>
                          <option value="">
                            https://www.ezrankings.org/seo-packages.html
                          </option>
                        </select>
                      </div>
                      <div className="col-md-4">
