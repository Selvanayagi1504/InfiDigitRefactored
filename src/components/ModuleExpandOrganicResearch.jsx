...
function ModuleExpandOrganicResearch() {
  ...
  const [selectionTypeGSCQueryTable, setSelectionTypeGSCQueryTable] =
    useState("checkbox");
              ...
              <TabPanel>
                ...
                <div>
                  <Table
                    ...
                    rowSelection={{ type: selectionTypeORTab, ...rowSelection }}
